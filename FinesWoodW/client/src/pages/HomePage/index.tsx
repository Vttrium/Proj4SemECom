...
import defauly from "@/assets/default_product.jpg";
...
export function HomePage() {
  ...
  const itemsPerPage = 3; // Exibir 3 produtos por vez
        ...
        <div id="carouselExample" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src={fundo} className="d-block w-100" alt="Banner 1" />
            </div>
            <div className="carousel-item">
              <img src={defauly} className="d-block w-100" alt="Banner 2" />
            </div>
            <div className="carousel-item">
              <img src={fundo} className="d-block w-100" alt="Banner 3" />
            </div>
          </div>
          ...
          <div className="products-list">
            {products.slice(currentIndex, currentIndex + itemsPerPage).map((product) => (
              <div key={product.id} className="product-card">
                <img
                  src={product.imageUrl && product.imageUrl.trim() !== "" ? product.imageUrl : "/src/assets/default_product.jpg"}
                  alt={product.name}
                />
                <h5>{product.name}</h5>
