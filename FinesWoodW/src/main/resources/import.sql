...
-- Inserção do usuário
INSERT INTO tb_user (name, email, password, created_at, updated_at) 
VALUES ('dev usuario', 'dev.user@example.com', '$2a$10$M9RmLoXAU3BkNVuJlFs.CeBBmFOeQu1RNC6WToj48MFU7GrsE5saO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
